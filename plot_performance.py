...
def load_performance_data(filepath="performance.csv"):
    """Load performance data from CSV."""
    df = pd.read_csv(filepath)
    return df


def plot_performance(df, output_file="performance_comparison.png"):
    """
...
def main():
    ...
    df = load_performance_data("performance.csv")
